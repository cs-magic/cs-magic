...
import { DEFAULT_LOCALE_TYPE, LocaleNameSpace, LocaleType } from '@/ds/locales'
...
export const useSwitchLocale = () => {
	...
	return (newLocale: LocaleType) => router.push({ pathname, query }, router.asPath, { locale: newLocale })
}
